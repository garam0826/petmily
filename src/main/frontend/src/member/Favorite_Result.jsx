                                ...
                                {animalInfos && (
                                    <div>
                                        ...
                                        <div className="analysis-results">
                                            ...
                                            <button onClick={() => getMembersByDesertionNo(desertionNo)}>찜한 사용자 보기</button>
                                        </div>
                                    </div>
                                )}
                            </div>
...
const Favorite_Result = ({ matches, loading, error, removeFavorite, getMembersDesertionNo }) => {
    const state = store.getState();
    const userId = state.isLoggedIn ? state.userData.mem_id : null;
                                    ...
                                    {animalInfos[desertionNo] && (
                                        <div>
                                            ...
                                            <div className="analysis-results">
                                                ...
                                                <p>중성화 여부: {animalInfos[desertionNo]?.neuterYn}</p>
                                                <button onClick={() => removeFavorite(desertionNo)}>찜 제거</button>
                                                <button onClick={() => getMembersDesertionNo(desertionNo)}>찜한 사용자 보기</button>
                                            </div>
                                        </div>
                                    )}
                                </div>
